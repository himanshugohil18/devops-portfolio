      ...
      <div className="container-wide relative">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-display mb-4">
            My CI/CD <span className="italic text-primary">Pipeline</span>
          </h2>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
            {pipelineSteps.map((step, index) => (
              ...
              >
                <div className="relative p-6 rounded-2xl bg-card/80 backdrop-blur-xl border border-border/50 hover:border-primary/50 transition-all duration-500 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-2">
                  {/* Glow */}
                  ...
                  <div className="relative text-center">
                    ...
                    <div className="w-16 h-16 mx-auto rounded-2xl bg-primary/10 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:bg-primary/20 transition-all duration-300">
        ...
        >
          <motion.div
            className="h-full w-32 bg-gradient-to-r from-transparent via-primary/50 to-transparent rounded-full"
            animate={{ x: ['-100%', '100%'] }}
