          ...
          >
            <div className="relative bg-card/95 backdrop-blur-xl rounded-3xl border border-border/50 shadow-2xl overflow-hidden">
              ...
              <div className="p-8 pt-12">
                ...
                <h2 className="text-2xl md:text-3xl font-display font-bold mb-4">{project.title}</h2>
                ...
                <div className="mb-8">
                  <h3 className="text-lg font-display font-semibold mb-3">Key Features</h3>
                ...
                {/* Tech Stack */}
                <div className="mb-8">
                  <h3 className="text-lg font-display font-semibold mb-3">Tech Stack</h3>
                  <div className="flex flex-wrap gap-2">
                    {project.stack.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1.5 text-xs font-medium bg-muted/60 rounded-lg text-muted-foreground border border-border/50"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex gap-4">
                  <button className="flex-1 inline-flex items-center justify-center px-6 py-3 bg-primary text-primary-foreground font-medium rounded-xl transition-all duration-300 glow-button hover:scale-[1.02]">
                    <ExternalLink className="w-4 h-4 mr-2" />
                    View Live Demo
                  </button>
                  <button className="flex-1 inline-flex items-center justify-center px-6 py-3 bg-card border border-border/50 text-foreground font-medium rounded-xl transition-all duration-300 hover:border-primary/30">
