  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-10">
        ...
        {/* Hero */}
        <div className="max-w-[1100px] mx-auto px-6 md:px-8 pt-[120px] pb-20">
          <motion.div
          ...
          >
            {/* Category line */}
            <p className="text-sm text-primary font-medium tracking-wide">{subtitle}</p>

            {/* Title */}
            <h1 className="text-3xl md:text-5xl font-display font-bold gradient-text leading-tight max-w-4xl">
              {title}
            </h1>
            ...
            {/* Executive Summary */}
            <div className="mt-6 glass-card rounded-2xl border border-border/40 p-10 md:p-12 max-w-3xl bg-card/50 backdrop-blur-xl hover:translate-y-0 hover:scale-100 transition-all duration-300"
              style={{ boxShadow: '0 4px 24px hsla(0,0%,0%,0.15)' }}
            >
              <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-primary mb-5">
                Executive Summary
              </h3>
              <p className="text-foreground/85 leading-[2] text-[15px]">{summary}</p>
            </div>
          </motion.div>
        </div>
